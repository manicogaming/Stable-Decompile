...
ZombieDefinition gZombieDefs[NUM_ZOMBIE_TYPES] = {  //0x69DA80
	{ ZOMBIE_NORMAL,            REANIM_ZOMBIE,              1,      1,      1,      1000,   _S("ZOMBIE") },
	{ ZOMBIE_FLAG,              REANIM_ZOMBIE,              1,      1,      1,      0,      _S("FLAG_ZOMBIE") },
	{ ZOMBIE_TRAFFIC_CONE,      REANIM_ZOMBIE,              2,      3,      1,      1000,   _S("CONEHEAD_ZOMBIE") },
	{ ZOMBIE_POLEVAULTER,       REANIM_POLEVAULTER,         2,      6,      5,      1000,   _S("POLE_VAULTING_ZOMBIE") },
	{ ZOMBIE_PAIL,              REANIM_ZOMBIE,              4,      8,      1,      1000,   _S("BUCKETHEAD_ZOMBIE") },
	{ ZOMBIE_NEWSPAPER,         REANIM_ZOMBIE_NEWSPAPER,    2,      11,     1,      1000,   _S("NEWSPAPER_ZOMBIE") },
	{ ZOMBIE_DOOR,              REANIM_ZOMBIE,              4,      13,     5,      1000,   _S("SCREEN_DOOR_ZOMBIE") },
	{ ZOMBIE_FOOTBALL,          REANIM_ZOMBIE_FOOTBALL,     7,      16,     5,      1000,   _S("FOOTBALL_ZOMBIE") },
	...
	{ ZOMBIE_SNORKEL,           REANIM_SNORKEL,             3,      23,     10,     1000,   _S("SNORKEL_ZOMBIE") },
	{ ZOMBIE_ZAMBONI,           REANIM_ZOMBIE_ZAMBONI,      7,      26,     10,     1000,   _S("ZOMBONI") },
	{ ZOMBIE_BOBSLED,           REANIM_BOBSLED,             3,      26,     10,     1000,   _S("ZOMBIE_BOBSLED_TEAM") },
	{ ZOMBIE_DOLPHIN_RIDER,     REANIM_ZOMBIE_DOLPHINRIDER, 3,      28,     10,     1000,   _S("DOLPHIN_RIDER_ZOMBIE") },
	{ ZOMBIE_JACK_IN_THE_BOX,   REANIM_JACKINTHEBOX,        3,      31,     10,     1000,   _S("JACK_IN_THE_BOX_ZOMBIE") },
	{ ZOMBIE_BALLOON,           REANIM_BALLOON,             2,      33,     10,     1000,   _S("BALLOON_ZOMBIE") },
	...
	{ ZOMBIE_CATAPULT,          REANIM_CATAPULT,            5,      46,     10,     1000,   _S("CATAPULT_ZOMBIE") },
	{ ZOMBIE_GARGANTUAR,        REANIM_GARGANTUAR,          10,     48,     15,     1000,   _S("GARGANTUAR") },
	{ ZOMBIE_IMP,               REANIM_IMP,                 10,     48,     1,      1000,   _S("IMP") },
	{ ZOMBIE_BOSS,              REANIM_BOSS,                10,     50,     1,      0,      _S("BOSS") },
	{ ZOMBIE_DOG_WALKER,        REANIM_NONE,                2,      11,     1,      1000,   _S("DOG_WALKING_ZOMBIE") },
	{ ZOMBIE_DOG,               REANIM_NONE,                2,      11,     1,      0,      _S("DOG_ZOMBIE") },
	{ ZOMBIE_PROPELLER,         REANIM_NONE,                2,      33,     10,     1000,   _S("PROPELLER_ZOMBIE") },
	{ ZOMBIE_PEA_HEAD,          REANIM_ZOMBIE,              1,      99,     1,      1000,   _S("ZOMBIE") },
	{ ZOMBIE_WALLNUT_HEAD,      REANIM_ZOMBIE,              4,      99,     1,      1000,   _S("ZOMBIE") },
	{ ZOMBIE_JALAPENO_HEAD,     REANIM_ZOMBIE,              3,      99,     10,     1000,   _S("ZOMBIE") },
	{ ZOMBIE_GATLING_HEAD,      REANIM_ZOMBIE,              3,      99,     10,     1000,   _S("ZOMBIE") },
	{ ZOMBIE_SQUASH_HEAD,       REANIM_ZOMBIE,              3,      99,     10,     1000,   _S("ZOMBIE") },
	{ ZOMBIE_TALLNUT_HEAD,      REANIM_ZOMBIE,              4,      99,     10,     1000,   _S("ZOMBIE") },
	{ ZOMBIE_REDEYE_GARGANTUAR, REANIM_GARGANTUAR,          10,     48,     15,     1000,   _S("REDEYED_GARGANTUAR") },
	{ ZOMBIE_BLACK_FOOTBALL,    REANIM_ZOMBIE_BLACKFOOTBALL,7,		16,		5,		1000,   _S("BLACK_FOOTBALL_ZOMBIE") },
	{ ZOMBIE_TRASHCAN,          REANIM_ZOMBIE,              4,      13,     5,      1000,	_S("TRASHCAN_ZOMBIE") },
	{ ZOMBIE_ANGRY,             REANIM_ZOMBIE,              1,      99,     1,		1000,   _S("ANGRY_ZOMBIE") },
	{ ZOMBIE_CONE_DOOR,         REANIM_ZOMBIE,              5,      99,     5,      1000,   _S("SCREEN_DOOR_CONE_ZOMBIE") },
	{ ZOMBIE_PAIL_DOOR,         REANIM_ZOMBIE,              6,      99,     5,      1000,   _S("SCREEN_DOOR_PAIL_ZOMBIE") },
	{ ZOMBIE_CONE_TRASHCAN,     REANIM_ZOMBIE,              5,      99,     5,      1000,   _S("TRASHCAN_CONE_ZOMBIE") },
	{ ZOMBIE_PAIL_TRASHCAN,     REANIM_ZOMBIE,              6,      99,     5,      1000,   _S("TRASHCAN_PAIL_ZOMBIE") },
	...
	{ ZOMBIE_VASE_GARGANTUAR,   REANIM_VASE_GARGANTUAR,     10,     99,     15,     1000,   _S("VASE_GARGANTUAR") },
};
...
void Zombie::ZombieInitialize(int theRow, ZombieType theType, bool theVariant, Zombie* theParentZombie, int theFromWave)
{
	...
	case ZombieType::ZOMBIE_VASE_GARGANTUAR:  //0x523D10
	{
		mWidth = 180;
		mHeight = 180;
		mBodyHealth = 3000;
		...
		else if (mZombieType == ZombieType::ZOMBIE_VASE_GARGANTUAR)
		{
			mBodyHealth = 3600;
		}
	...
	case ZombieType::ZOMBIE_SUNDAYPAPER:  //0x52333D
		mZombieAttackRect = Rect(20, 0, 50, 115);
		mZombiePhase = ZombiePhase::PHASE_NEWSPAPER_READING;
		mShieldType = ShieldType::SHIELDTYPE_SUNDAYPAPER;
		mShieldHealth = 1800;
		mBodyHealth = 470;
		mVariant = false;
		AttachShield();
	...
	case ZombieType::ZOMBIE_BRICK:  //0x5228A4
		LoadPlainZombieReanim();
...
void Zombie::SetupReanimLayers(Reanimation* aReanim, ZombieType theZombieType)
{
	...
	else if (theZombieType == ZombieType::ZOMBIE_DOOR || theZombieType == ZombieType::ZOMBIE_TRASHCAN)
	{
	...
	else if (theZombieType == ZombieType::ZOMBIE_SUNDAYPAPER)
	{
		aReanim->AssignRenderGroupToPrefix("Zombie_sundaypaper_paper", RENDER_GROUP_HIDDEN);
	}
...
Plant* Zombie::FindCatapultTarget()
{
	...
	{
		if (aPlant->mRow == mRow && mX >= aPlant->mX + 100 && !aPlant->NotOnGround() && !aPlant->IsSpiky() && aPlant->mSeedType != SeedType::SEED_YAMPOLINE)
		{
...
{
	if (mApp->mGameMode == GameMode::GAMEMODE_CHALLENGE_HIGH_GRAVITY && mPosX < 720.0f && (mZombiePhase == ZombiePhase::PHASE_BALLOON_FLYING || mZombiePhase == ZombiePhase::PHASE_PROPELLER_FLYING))
	{
		mAltitude -= 0.1f;
		if (mAltitude < -35.0f)
		{
	...
	if (mApp->IsIZombieLevel() && (mZombiePhase == ZombiePhase::PHASE_BALLOON_FLYING || mZombiePhase == ZombiePhase::PHASE_BALLOON_SWING || mZombiePhase == ZombiePhase::PHASE_PROPELLER_FLYING) && mBoard->mChallenge->IZombieGetBrainTarget(this))
	{
		LandFlyer(0U);
	}
}
...
void Zombie::UpdateZombiePool()
{
	...
	else if (mZombieHeight == ZombieHeight::HEIGHT_IN_TO_POOL)
	{
		...
		if (mZombieType == ZombieType::ZOMBIE_BALLOON || mZombieType == ZombieType::ZOMBIE_PROPELLER)
		{
			if (mAltitude <= aDepth / 2) {
				if (mZombiePhase == ZombiePhase::PHASE_BALLOON_POPPING || mZombiePhase == ZombiePhase::PHASE_BALLOON_WALKING || mZombiePhase == ZombiePhase::PHASE_PROPELLER_WALKING) {
					PoolSplash(true);
					DieWithLoot();
				}
			}
...
bool Zombie::CanLoseBodyParts()
{
    return 
        ...
        mZombieType != ZombieType::ZOMBIE_VASE_GARGANTUAR &&
        mZombieHeight != ZombieHeight::HEIGHT_ZOMBIQUARIUM && 
        !IsFlying() && 
...
void Zombie::DropHead(unsigned int theDamageFlags)
{
	...
	if (mZombieType == ZombieType::ZOMBIE_NEWSPAPER || mZombieType == ZombieType::ZOMBIE_SUNDAYPAPER)
	{
...
void Zombie::SetupReanimForLostArm(unsigned int theDamageFlags)
{
	...
	if (aBodyReanim)
	{
		...
		case ZombieType::ZOMBIE_SUNDAYPAPER:
			GetTrackPosition("Zombie_paper_leftarm_lower", aPosX, aPosY);
			aBodyReanim->SetImageOverride("Zombie_paper_sundayleftarm_upper", IMAGE_REANIM_ZOMBIE_SUNDAYPAPER_LEFTARM_UPPER2);
			break;
		case ZombieType::ZOMBIE_SUPERFAN_IMP:
			GetTrackPosition("Zombie_outerarm_lower", aPosX, aPosY);
...
void Zombie::DropArm(unsigned int theDamageFlags)
{
	...
	if (mShieldType == ShieldType::SHIELDTYPE_DOOR || mShieldType == ShieldType::SHIELDTYPE_TRASHCAN || mShieldType == ShieldType::SHIELDTYPE_NEWSPAPER ||
		mShieldType == ShieldType::SHIELDTYPE_SUNDAYPAPER || mZombieType == ZombieType::ZOMBIE_BUNGEE)
	{
		return;
	}
...
void Zombie::UpdateActions()
{
	...
	if (mZombieType == ZombieType::ZOMBIE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_REDEYE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_VASE_GARGANTUAR)
	{
...
void Zombie::UpdateZombieSuperFanImp() 
{
	if (mZombiePhase == ZombiePhase::PHASE_ZOMBIE_NORMAL)
	{
		Plant* aPlant = FindPlantTarget(ZombieAttackType::ATTACKTYPE_CHEW);
		if (aPlant)
		{
			PlayZombieReanim("anim_explode", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 20, 28.0f);
			mZombiePhase = ZombiePhase::PHASE_IMP_EXPLODING;
			mPhaseCounter = 40;
		}
	}
	else if (mZombiePhase == ZombiePhase::PHASE_IMP_EXPLODING)
	{
		if (mPhaseCounter <= 0)
		{
			mApp->PlayFoley(FoleyType::FOLEY_EXPLOSION);
			...
			if (mMindControlled)
			{
				mBoard->KillAllZombiesInRadius(mRow, aPosX, aPosY, 80, 1, true, 127);
			}
			else
			{
				mBoard->KillAllZombiesInRadius(mRow, aPosX, aPosY, 80, 1, true, 255);
				mBoard->KillAllPlantsInRadius(aPosX, aPosY, 80);
			}
...
void Zombie::Animate()
{
	...
	if (mIsEating && mHasHead)
	{
		...
		if (aBodyReanim)
		{
			...
			else if (mZombieType == ZombieType::ZOMBIE_NEWSPAPER || mZombieType == ZombieType::ZOMBIE_LADDER || mZombieType == ZombieType::ZOMBIE_SUNDAYPAPER)
			{
				aLeftHandTime = 0.42f;
...
void Zombie::UpdateReanim()
{
	...
	float scaleMultiplier = mZombieType == ZombieType::ZOMBIE_DANCER || mZombieType == ZombieType::ZOMBIE_BACKUP_DANCER ? 0.79872f : 1.0f;
...
void Zombie::DrawReanim(Graphics* g, const ZombieDrawPosition& theDrawPos, int theBaseRenderGroup)
{
	...
	if (mHelmType == HelmType::HELMTYPE_TRAFFIC_CONE || mHelmType == HelmType::HELMTYPE_BUCKET || mHelmType == HelmType::HELMTYPE_FOOTBALL || mHelmType == HelmType::HELMTYPE_DIGGER ||
		mHelmType == HelmType::HELMTYPE_BLACK_FOOTBALL || mHelmType == HelmType::HELMTYPE_BRICK)
	{
		aBodyReanim->mColorOverride = aColorOverride;
		aBodyReanim->mExtraAdditiveColor = aExtraAdditiveColor;
		aBodyReanim->mEnableExtraAdditiveDraw = aEnableExtraAdditiveDraw;
	...
	if (mShieldType == ShieldType::SHIELDTYPE_NEWSPAPER || mShieldType == ShieldType::SHIELDTYPE_DOOR || mShieldType == ShieldType::SHIELDTYPE_TRASHCAN ||
		mShieldType == ShieldType::SHIELDTYPE_LADDER || mShieldType == ShieldType::SHIELDTYPE_SUNDAYPAPER)
	{
		aBodyReanim->mColorOverride = aColorOverride;
		aBodyReanim->mExtraAdditiveColor = aExtraAdditiveColor;
		aBodyReanim->mEnableExtraAdditiveDraw = aEnableExtraAdditiveDraw;
...
void Zombie::GetDrawPos(ZombieDrawPosition& theDrawPos)
{
	...
	case ZombieType::ZOMBIE_VASE_GARGANTUAR:
...
void Zombie::Draw(Graphics* g)
{
	...
	if (mZombieType != ZombieType::ZOMBIE_BOSS && IsOnBoard() && mApp->mShowHealthBar && mHasHead && !IsDeadOrDying() && !mApp->IsWhackAZombieLevel() &&
		...
		if (mZombieType == ZombieType::ZOMBIE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_REDEYE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_VASE_GARGANTUAR) HEALTH_POSY -= 60;
...
bool Zombie::CanTargetPlant(Plant* thePlant, ZombieAttackType theAttackType)
{
	...
	if (thePlant->IsSpiky() || thePlant->mSeedType == SeedType::SEED_YAMPOLINE)
	{
		return
			mZombieType == ZombieType::ZOMBIE_GARGANTUAR ||
			mZombieType == ZombieType::ZOMBIE_REDEYE_GARGANTUAR ||
...
void Zombie::SquishAllInSquare(int theX, int theY, ZombieAttackType theAttackType)
{
	...
	while (mBoard->IteratePlants(aPlant))
	{
		if (aPlant->mRow == theY && aPlant->mPlantCol == theX)
		{
			...
			if (aPlant->mSeedType != SeedType::SEED_SPIKEROCK && /*aPlant->mSeedType != SeedType::SEED_WALLNUT && aPlant->mSeedType != SeedType::SEED_TALLNUT &&*/ aPlant->mSeedType != SeedType::SEED_STINGER)
			{
				mBoard->mPlantsEaten++;
				aPlant->Squish();

				if (aPlant->mSeedType == SEED_COBCANNON)
				{
					Plant* aPlant2 = nullptr;
					while (mBoard->IteratePlants(aPlant2))
					{
						if (aPlant2->mRow == theY && aPlant2->mPlantCol == theX + 1)
						{
							if (aPlant2->mSeedType != SeedType::SEED_SPIKEROCK)
							{
								mBoard->mPlantsEaten++;
								aPlant2->Squish();
							}
...
void Zombie::StartWalkAnim(int theBlendTime)
{
	...
	else if (mInPool && mZombieHeight != ZombieHeight::HEIGHT_IN_TO_POOL && mZombieHeight != ZombieHeight::HEIGHT_OUT_OF_POOL && aBodyReanim->TrackExists("anim_swim"))
	{
		...
		mZombieType == ZombieType::ZOMBIE_ANGRY || mZombieType == ZombieType::ZOMBIE_BRICK) && mBoard->mDanceMode)
	{
...
void Zombie::DropShield(unsigned int theDamageFlags)
{
	...
	else if (mShieldType == ShieldType::SHIELDTYPE_SUNDAYPAPER)
	{
		StopEating();
		if (mYuckyFace)
		{
		...
		{
			float aPosX, aPosY;
			GetTrackPosition("Zombie_sundaypaper_paper", aPosX, aPosY);
			aParticle = mApp->AddTodParticle(aPosX, aPosY, mRenderOrder + 1, ParticleEffect::PARTICLE_ZOMBIE_NEWSPAPER);
			OverrideParticleColor(aParticle);
			OverrideParticleScale(aParticle);
			if (aShieldDamageIndex == 0) {
				aParticle->OverrideImage(nullptr, IMAGE_REANIM_ZOMBIE_SUNDAYPAPER_PAPER1);
			}
			else if (aShieldDamageIndex == 1) {
				aParticle->OverrideImage(nullptr, IMAGE_REANIM_ZOMBIE_SUNDAYPAPER_PAPER2);
			}
			else
			{
				aParticle->OverrideImage(nullptr, IMAGE_REANIM_ZOMBIE_SUNDAYPAPER_PAPER3);
			}
		}
...
int Zombie::TakeShieldDamage(int theDamage, unsigned int theDamageFlags)
{
	...
	if (aDamageIndexAfterDamage != aDamageIndexBeforeDamage)
	{
		...
		else if (mShieldType == ShieldType::SHIELDTYPE_SUNDAYPAPER && aDamageIndexAfterDamage == 1)
		{
			TOD_ASSERT(aBodyReanim);
			aBodyReanim->SetImageOverride("Zombie_sundaypaper_paper", IMAGE_REANIM_ZOMBIE_SUNDAYPAPER_PAPER2);
		}
		else if (mShieldType == ShieldType::SHIELDTYPE_SUNDAYPAPER && aDamageIndexAfterDamage == 2)
		{
			TOD_ASSERT(aBodyReanim);
			aBodyReanim->SetImageOverride("Zombie_sundaypaper_paper", IMAGE_REANIM_ZOMBIE_SUNDAYPAPER_PAPER3);
		}
	}
...
void Zombie::DropHelm(unsigned int theDamageFlags)
{
	...
	if (!TestBit(theDamageFlags, (int)DamageFlags::DAMAGE_DOESNT_LEAVE_BODY) && aEffect != ParticleEffect::PARTICLE_NONE)
	{
		...
		{
			if (aHelmetDamageIndex == 0) {
				aParticle->OverrideImage(nullptr, IMAGE_REANIM_ZOMBIE_BRICK1);
			}
			else if (aHelmetDamageIndex == 1) {
				aParticle->OverrideImage(nullptr, IMAGE_REANIM_ZOMBIE_BRICK2);
			}
			else {
				aParticle->OverrideImage(nullptr, IMAGE_REANIM_ZOMBIE_BRICK3);
			}
		}
	}
...
int Zombie::TakeHelmDamage(int theDamage, unsigned int theDamageFlags)
{
	...
	if (aDamageIndexBeforeDamage != aDamageIndexAfterDamage)
	{
		...
		else if (mHelmType == HelmType::HELMTYPE_BRICK && aDamageIndexAfterDamage == 1 && aBodyReanim)
		{
			aBodyReanim->SetImageOverride("anim_brick", IMAGE_REANIM_ZOMBIE_BRICK2);
		}
		else if (mHelmType == HelmType::HELMTYPE_BRICK && aDamageIndexAfterDamage == 2 && aBodyReanim)
		{
...
void Zombie::ApplyButter()
{
	...
	Zombie* aZombie = mBoard->ZombieTryToGet(mRelatedZombieID);
	if (aZombie && aZombie->mZombieType != ZombieType::ZOMBIE_DANCER && aZombie->mZombieType != ZombieType::ZOMBIE_BACKUP_DANCER && aZombie->mZombieType != ZombieType::ZOMBIE_DOG_WALKER && aZombie->mZombieType != ZombieType::ZOMBIE_DOG)
	{
		aZombie->mRelatedZombieID = ZombieID::ZOMBIEID_NULL;
		mRelatedZombieID = ZombieID::ZOMBIEID_NULL;
	}
...
void Zombie::MowDown()
{
	...
	else if (mZombieType == ZombieType::ZOMBIE_NEWSPAPER || mZombieType == ZombieType::ZOMBIE_BALLOON || mZombieType == ZombieType::ZOMBIE_SUNDAYPAPER)
	{
		DropHead(0U);
	}
	else if (mZombieType == ZombieType::ZOMBIE_POGO)
...
void Zombie::ApplyBurn()
{
	...
	DropShield(0U);
	DropFlag();
	if (mZombieType == ZOMBIE_NEWSPAPER || mZombieType == ZOMBIE_SUNDAYPAPER) {
    ...
    else
    {
        ...
        else if (mZombieType == ZombieType::ZOMBIE_DIGGER)
        {
			...
			mZombieType == ZombieType::ZOMBIE_VASE_GARGANTUAR) && !mHasObject)
        {
...
void Zombie::AttachHelmet()
{
	...
	if (aBodyReanim)
	{
		if (mHelmType == HelmType::HELMTYPE_TRAFFIC_CONE) {
			...
			ReanimShowPrefix("anim_brick", RENDER_GROUP_OVER_HELMET);
			aTrackName = "anim_brick";
		}
...
void Zombie::AttachShield()
{
	...
	if (aBodyReanim)
	{
		...
		{
			ReanimShowPrefix("Zombie_paper_hands", RENDER_GROUP_OVER_SHIELD);
			aTrackName = "Zombie_sundaypaper_paper";
		}
		else
		{
			TOD_ASSERT();
...
void Zombie::DetachShield()
{
	...
	if (aBodyReanim)
	{
		...
		else if (mShieldType == ShieldType::SHIELDTYPE_NEWSPAPER || mShieldType == ShieldType::SHIELDTYPE_SUNDAYPAPER)
		{
...
void Zombie::PlayDeathAnim(unsigned int theDamageFlags)
{
	...
	else if (mZombieType == ZombieType::ZOMBIE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_REDEYE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_VASE_GARGANTUAR)
	{
...
bool Zombie::PreloadZombieResources(ZombieType theZombieType)
{
	...
	else if (theZombieType == ZombieType::ZOMBIE_GARGANTUAR || theZombieType == ZombieType::ZOMBIE_REDEYE_GARGANTUAR || theZombieType == ZombieType::ZOMBIE_VASE_GARGANTUAR)
	{
...
void Zombie::EnableDance(bool theEnableDance)
{
	...
	if (mZombieType == ZombieType::ZOMBIE_NORMAL || mZombieType == ZombieType::ZOMBIE_TRAFFIC_CONE || mZombieType == ZombieType::ZOMBIE_PAIL ||
		mZombieType == ZombieType::ZOMBIE_ANGRY || mZombieType == ZombieType::ZOMBIE_BRICK)
	{
		//StartWalkAnim(0);
		Reanimation* aBodyReanim = mApp->ReanimationTryToGet(mBodyReanimID);
		if (aBodyReanim == nullptr)
