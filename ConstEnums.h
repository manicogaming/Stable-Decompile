...
enum ChallengePage
{
    ...
    CHALLENGE_PAGE_QUICKPLAY = 5,
    CHALLENGE_PAGE_EXTRA_CHALLENGE = 6,
    CHALLENGE_PAGE_EXTRA_SURVIVAL = 7,
    CHALLENGE_PAGE_EXTRA_PUZZLE = 8,
    MAX_CHALLANGE_PAGES = 9
};
enum ChallengeState
{
...
enum SeedType
{
    ...
    SEED_IMITATER = 48,
    SEED_TIMESTOPPER = 49,
    SEED_ICEBERGLETTUCE = 50,
    SEED_CHERRYHOVERBOMB = 51,
    SEED_STINGER = 52,
    SEED_DUPLICATORCYCLER = 53,
    SEED_BEEHIVE = 54,
    SEED_YAMPOLINE = 55,
    SEED_NUKECUMBER = 56,
    SEED_EXPLODE_O_NUT,
    ...
    SEED_ZOMBIE_IMP,
    NUM_SEEDS_IN_CHOOSER = (int) NUM_SEED_TYPES, //49
    SEED_NONE = -1
};
enum ShieldType
{
...
enum ZombieType
{
    ...
    ZOMBIE_CONE_DOOR,
    ZOMBIE_PAIL_DOOR,
    ZOMBIE_CONE_TRASHCAN,
    ZOMBIE_PAIL_TRASHCAN,
    NUM_ZOMBIE_TYPES,
