...
public:
	FSOUND_SAMPLE*			LoadFMODSample(const SexyString& theFileName);

public:
	FModMusicInterface(HWND theHWnd);
	virtual ~FModMusicInterface();
		
	virtual bool			LoadMusic(int theSongId, const SexyString& theFileName);
	virtual bool			LoadSample(int theSongId, const SexyString& theFileName, bool repeat);
	virtual bool			LoadSample(int theSongId, const SexyString& theIntroFileName, const SexyString& theRepeatFileName, bool repeat);
