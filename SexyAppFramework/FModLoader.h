...
struct FMOD_INSTANCE
{
    ...
    FSOUND_SAMPLE* (F_API* FSOUND_Sample_Load)(int index, const SexyChar* name_or_data, unsigned int mode, int memlength);
    ...
    FMUSIC_MODULE* (F_API* FMUSIC_LoadSong)(const SexyChar* name);
