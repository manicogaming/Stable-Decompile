...
png_combine_row(png_structp png_ptr, png_bytep row, int mask)
{
   ...
   png__DEBUG(1,"in png_combine_row_asm\n");
   ...
   row, png_bytep prev_row, int filter)
{
   ...
   png__DEBUG2(0,"row=%5d, %s, ", png_ptr->row_number, filnm);
   png__DEBUG2(0, "pd=%2d, b=%d, ", (int)row_info->pixel_depth,
      (int)((row_info->pixel_depth + 7) >> 3));
   png__DEBUG1(0,"len=%8d, ", row_info->rowbytes);
#endif
