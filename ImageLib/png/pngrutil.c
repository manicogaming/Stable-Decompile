...
png_handle_IHDR(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   png__DEBUG(1, "in png_handle_IHDR\n");
   ...
   png__DEBUG1(3,"bit_depth = %d\n", png_ptr->bit_depth);
   png__DEBUG1(3,"channels = %d\n", png_ptr->channels);
   png__DEBUG1(3,"rowbytes = %d\n", png_ptr->rowbytes);
...
png_handle_PLTE(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   png__DEBUG(1, "in png_handle_PLTE\n");
...
{
   png__DEBUG(1, "in png_handle_IEND\n");
...
png_handle_gAMA(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   png__DEBUG(1, "in png_handle_gAMA\n");
...
png_handle_sBIT(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   png__DEBUG(1, "in png_handle_sBIT\n");
...
png_handle_cHRM(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   png__DEBUG(1, "in png_handle_cHRM\n");
...
png_handle_sRGB(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   png__DEBUG(1, "in png_handle_sRGB\n");
...
{
   png__DEBUG(1, "in png_handle_tRNS\n");
...
png_handle_bKGD(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   png__DEBUG(1, "in png_handle_bKGD\n");
...
png_handle_hIST(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   png__DEBUG(1, "in png_handle_hIST\n");
...
png_handle_pHYs(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   png__DEBUG(1, "in png_handle_pHYs\n");
...
png_handle_oFFs(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   png__DEBUG(1, "in png_handle_oFFs\n");
...
png_handle_pCAL(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   png__DEBUG(1, "in png_handle_pCAL\n");
   ...
   png__DEBUG1(2, "Allocating and reading pCAL chunk data (%d bytes)\n",
      length + 1);
   ...
   png__DEBUG(3, "Finding end of pCAL purpose string\n");
   ...
   png__DEBUG(3, "Reading pCAL X0, X1, type, nparams, and units\n");
   ...
   png__DEBUG(3, "Checking pCAL equation type and number of parameters\n");
   ...
   png__DEBUG(3, "Allocating pCAL parameters array\n");
   ...
   for (i = 0; i < (int)nparams; i++)
   {
      ...
      png__DEBUG1(3, "Reading pCAL parameter %d\n", i);
...
png_handle_tIME(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   png__DEBUG(1, "in png_handle_tIME\n");
...
png_handle_tEXt(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   png__DEBUG(1, "in png_handle_tEXt\n");
...
png_handle_zTXt(png_structp png_ptr, png_infop info_ptr, png_uint_32 length)
{
   ...
   png__DEBUG(1, "in png_handle_zTXt\n");
...
{
   png__DEBUG(1, "in png_handle_unknown\n");
...
{
   png__DEBUG(1, "in png_check_chunk_name\n");
...
{
   png__DEBUG(1,"in png_combine_row\n");
   if (mask == 0xff)
   {
...
{
   png__DEBUG(1,"in png_do_read_interlace\n");
...
{
   png__DEBUG(1, "in png_read_filter_row\n");
   png__DEBUG2(2,"row = %d, filter = %d\n", png_ptr->row_number, filter);
   switch (filter)
   {
...
{
   png__DEBUG(1, "in png_read_finish_row\n");
   png_ptr->row_number++;
...
png_read_start_row(png_structp png_ptr)
{
   ...
   png__DEBUG(1, "in png_read_start_row\n");
   png_ptr->zstream.avail_in = 0;
   ...
   png__DEBUG1(3, "width = %d,\n", png_ptr->width);
   png__DEBUG1(3, "height = %d,\n", png_ptr->height);
   png__DEBUG1(3, "iwidth = %d,\n", png_ptr->iwidth);
   png__DEBUG1(3, "num_rows = %d\n", png_ptr->num_rows);
   png__DEBUG1(3, "rowbytes = %d,\n", png_ptr->rowbytes);
   png__DEBUG1(3, "irowbytes = %d,\n", png_ptr->irowbytes);
