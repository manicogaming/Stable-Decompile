...
{
   png_byte buf[4];
   png__DEBUG2(0, "Writing %s chunk (%d bytes)\n", chunk_name, length);
   ...
   int interlace_type)
{
   ...
   png__DEBUG(1, "in png_write_IHDR\n");
...
png_write_PLTE(png_structp png_ptr, png_colorp palette, png_uint_32 num_pal)
{
   ...
   png__DEBUG(1, "in png_write_PLTE\n");
   if ((
...
{
   png__DEBUG(1, "in png_write_IDAT\n");
...
{
   png__DEBUG(1, "in png_write_IEND\n");
...
png_write_gAMA(png_structp png_ptr, double file_gamma)
{
   ...
   png__DEBUG(1, "in png_write_gAMA\n");
...
png_write_sRGB(png_structp png_ptr, int srgb_intent)
{
   ...
   png__DEBUG(1, "in png_write_sRGB\n");
...
png_write_sBIT(png_structp png_ptr, png_color_8p sbit, int color_type)
{
   ...
   png__DEBUG(1, "in png_write_sBIT\n");
   ...
   double blue_x, double blue_y)
{
   ...
   png__DEBUG(1, "in png_write_cHRM\n");
   ...
   int num_trans, int color_type)
{
   ...
   png__DEBUG(1, "in png_write_tRNS\n");
...
png_write_bKGD(png_structp png_ptr, png_color_16p back, int color_type)
{
   ...
   png__DEBUG(1, "in png_write_bKGD\n");
   if (color_type == PNG_COLOR_TYPE_PALETTE)
   {
      if (
#ifdef PNG_WRITE_EMPTY_PLTE_SUPPORTED
...
png_write_hIST(png_structp png_ptr, png_uint_16p hist, int num_hist)
{
   ...
   png__DEBUG(1, "in png_write_hIST\n");
   if (num_hist > (int)png_ptr->num_palette)
   {
      png__DEBUG2(3, "num_hist = %d, num_palette = %d\n", num_hist,
         png_ptr->num_palette);
...
png_check_keyword(png_structp png_ptr, png_charp key, png_charpp new_key)
{
   ...
   png__DEBUG(1, "in png_check_keyword\n");
   *new_key = NULL;
   ...
   png__DEBUG1(2, "Keyword to be checked is '%s'\n", key);
   ...
   *dp = '\0';
   ...
   png__DEBUG1(2, "Checking for multiple internal spaces in '%s'\n", kp);
   ...
   png_size_t text_len)
{
   ...
   png__DEBUG(1, "in png_write_tEXt\n");
   ...
   png_size_t text_len, int compression)
{
   ...
   png__DEBUG(1, "in png_write_zTXt\n");
   ...
   int unit_type)
{
   ...
   png__DEBUG(1, "in png_write_oFFs\n");
   ...
   png_int_32 X1, int type, int nparams, png_charp units, png_charpp params)
{
   ...
   png__DEBUG1(1, "in png_write_pCAL (%d parameters)\n", nparams);
   if (type >= PNG_EQUATION_LAST)
      png_warning(png_ptr, "Unrecognized equation type for pCAL chunk");

   purpose_len = png_check_keyword(png_ptr, purpose, &new_purpose) + 1;
   png__DEBUG1(3, "pCAL purpose length = %d\n", purpose_len);
   units_len = png_strlen(units) + (nparams == 0 ? 0 : 1);
   png__DEBUG1(3, "pCAL units length = %d\n", units_len);
   ...
   for (i = 0; i < nparams; i++)
   {
      ...
      png__DEBUG2(3, "pCAL parameter %d length = %d\n", i, params_len[i]);
      total_len += (png_size_t)params_len[i];
   }

   png__DEBUG1(3, "pCAL total length = %d\n", total_len);
   ...
   int unit_type)
{
   ...
   png__DEBUG(1, "in png_write_pHYs\n");
...
png_write_tIME(png_structp png_ptr, png_timep mod_time)
{
   ...
   png__DEBUG(1, "in png_write_tIME\n");
...
png_write_start_row(png_structp png_ptr)
{
   ...
   png__DEBUG(1, "in png_write_start_row\n");
...
png_write_finish_row(png_structp png_ptr)
{
   ...
   png__DEBUG(1, "in png_write_finish_row\n");
   /* next row */
   png_ptr->row_number++;
...
{
   png__DEBUG(1, "in png_do_write_interlace\n");
...
png_write_find_filter(png_structp png_ptr, png_row_infop row_info)
{
   ...
   png__DEBUG(1, "in png_write_find_filter\n");
...
{
   png__DEBUG(1, "in png_write_filtered_row\n");
   png__DEBUG1(2, "filter = %d\n", filtered_row[0]);
