...
/* Define PNG__DEBUG at compile time for debugging information.  Higher
 * numbers for PNG__DEBUG mean more debugging information.  This has
 * only been added since version 0.95 so it is not implemented throughout
 * libpng yet, but more support will be added as needed.
 */
#ifdef PNG__DEBUG
#if (PNG__DEBUG > 0)
#ifndef PNG__DEBUG_FILE
#define PNG__DEBUG_FILE stderr
#endif /* PNG__DEBUG_FILE */

#define png__DEBUG(l,m)        if (PNG__DEBUG > l) \
                                 fprintf(PNG__DEBUG_FILE,"%s"m,(l==1 ? "\t" : \
                                    (l==2 ? "\t\t":(l>2 ? "\t\t\t":""))))
#define png__DEBUG1(l,m,p1)    if (PNG__DEBUG > l) \
                                 fprintf(PNG__DEBUG_FILE,"%s"m,(l==1 ? "\t" : \
                                    (l==2 ? "\t\t":(l>2 ? "\t\t\t":""))),p1)
#define png__DEBUG2(l,m,p1,p2) if (PNG__DEBUG > l) \
                                 fprintf(PNG__DEBUG_FILE,"%s"m,(l==1 ? "\t" : \
                                    (l==2 ? "\t\t":(l>2 ? "\t\t\t":""))),p1,p2)
#endif /* (PNG__DEBUG > 0) */
#endif /* PNG__DEBUG */
#ifndef png__DEBUG
#define png__DEBUG(l, m)
#endif
#ifndef png__DEBUG1
#define png__DEBUG1(l, m, p1)
#endif
#ifndef png__DEBUG2
#define png__DEBUG2(l, m, p1, p2)
#endif
